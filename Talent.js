document.addEventListener("DOMContentLoaded", () => {
  ...
  images.forEach((img, index) => {
    ...
    }, index * 500); // ทีละรูปหน่วงเวลา 0.5 วิ
  });
});
...
document.addEventListener("mousemove", (e) => {
  // อัปเดตตำแหน่งดาวหลัก
  cursorStar.style.left = e.pageX + "px";
  cursorStar.style.top = e.pageY + "px";
